...
func newOrdersTableImpl(schemaName, tableName, alias string) ordersTable {
	var (
		...
		allColumns      = postgres.ColumnList{IDColumn, UserIDColumn, StatusColumn, AccrualColumn, CreatedAtColumn, UpdatedAtColumn, DeletedAtColumn}
		mutableColumns  = postgres.ColumnList{UserIDColumn, StatusColumn, AccrualColumn, CreatedAtColumn, UpdatedAtColumn, DeletedAtColumn}
	)
