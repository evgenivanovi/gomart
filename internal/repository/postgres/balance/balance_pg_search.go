...
func idExpression(
	...
	return table.Balances.ID.EQ(pgjet.Int(id.ID()))
}
...
func idsExpression(
	...
	return table.Balances.ID.IN(exp...)
}

func userIDExpression(
	id common.UserID,
) pgjet.BoolExpression {
	return table.Balances.UserID.EQ(pgjet.Int(id.ID()))
}
...
func userIDsExpression(
	...
	return table.Balances.UserID.IN(exp...)
}
